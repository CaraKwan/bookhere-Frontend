...
class LoginPage extends React.Component {
  ...
  handleLogin = async () => {
    ...
    //Validate input data in front end, only preceed when no error
    try {
    ...
    //Send login request to server, inform App.js the successful log in status, then set loading back to false
    try {
  ...
  render() {
    return (
      <div 
      style={{ width: 500, margin: "250px auto"}}>
