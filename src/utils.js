...
export const searchStays = (query) => {
  ...
  searchStaysUrl.searchParams.append("lat", 37.5);
  searchStaysUrl.searchParams.append("lon", -122.5);
  searchStaysUrl.searchParams.append("distance", query.distance);
...
//Get reservation list for stay api
